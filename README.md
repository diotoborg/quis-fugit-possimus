# @diotoborg/quis-fugit-possimus ![CI](https://github.com/diotoborg/quis-fugit-possimus/workflows/CI/badge.svg) [![NPM version](https://img.shields.io/npm/v/@diotoborg/quis-fugit-possimus.svg?style=flat)](https://npmjs.org/package/@diotoborg/quis-fugit-possimus) [![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg)](https://conventionalcommits.org) <!-- omit from toc -->
...
Next, install `@diotoborg/quis-fugit-possimus`:

```sh
npm install @diotoborg/quis-fugit-possimus --save-dev
```
...
```js
const eslintPlugin = require('@diotoborg/quis-fugit-possimus');
module.exports = [
...
💼 [Configurations](https://github.com/diotoborg/quis-fugit-possimus#presets) enabled in.\
✅ Set in the `recommended` [configuration](https://github.com/diotoborg/quis-fugit-possimus#presets).\
